...
using Maria.Threading;
using Maria.Diagnostics;
using UnityEngine;
...
namespace Maria.Editor
{
    ...
    public class PluginLoader
    {
        ...
        //--------------------------------------------------------------------------------------
        private Maria.Diagnostics.Logger createLogger()
        {
            Maria.Diagnostics.LoggerCreationInfo logger_creation_info = new Maria.Diagnostics.LoggerCreationInfo
            {
            ...
            return new Maria.Diagnostics.Logger(logger_creation_info);
        }
    }
}
